        ...
        className='bg-white md:w-[50%] min-w-120 w-full md:h-full md:rounded-r-lg py-10 shadow-lg shadow-black '>
          ...
          <div className='w-full flex flex-col items-center gap-2'>
            <div className='w-full flex justify-center'>
              <div className='bg-purple-600/50 rounded-full p-3'><MdLockOutline className='text-2xl text-white'/></div>
            </div>
            <h1 className='text-4xl font-semibold font-mono tracking-tight'>Welcome Back</h1>
            <p className='text-sm text-black/60'>Login to continue to Meetify</p>
          </div>

          {/* sign up form */}
          <div className='w-full flex flex-col items-center'>
            <form className='w-[50%] min-w-100 flex flex-col justify-center gap-5 mt-20' onSubmit={handleSubmit}>
                ...
                {/* Submit button */}
                <div className='w-full flex justify-center'>
                  <button type='submit' className='button bg-primary w-full'> <span className='text-xl'><BiLogIn /></span> Login</button>
                </div>
            </form>
            <div className='w-[50%] min-w-100  flex flex-col gap-7 mt-4'>
            ...
            {/* login option */}
            <p className='w-full flex justify-center gap-1 text-black/60 text-sm cursor-pointer' onClick={()=>navigate('/signup')}>Dont have an account? <span className='text-primary font-semibold'>Signup</span></p>
            </div>
          </div>
        </motion.div>
      </div>
